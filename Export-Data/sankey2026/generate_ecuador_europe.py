#!/usr/bin/env python3
"""Generate Sankey diagrams for Ecuador exports to Europe"""
import sys
...
def main():
    """Generate Ecuador to Europe sankey diagram"""
    DB_PATH = "../data/exports.db"
    OUTPUT_DIR = Path(__file__).parent / "ecuador" / "europe"
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

    print("="*60)
    print("Generating Ecuador → Europe Sankey Diagram")
    print("="*60)
    ...
    # Write mermaid file
    mmd_file = OUTPUT_DIR / "sankey-ecuador-europe-all-fruits.mmd"
    mmd_file.write_text(output)
    print(f"\n✓ Mermaid file: {mmd_file}")

    # Generate PNG using mmdc
    png_file = OUTPUT_DIR / "sankey-ecuador-europe-all-fruits.png"
    ...
    print("\n" + "="*60)
    print("✓ Ecuador → Europe Sankey complete!")
    print("="*60)
